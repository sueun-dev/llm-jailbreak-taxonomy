...
**상세 문서**: [`docs/TAXONOMY.md`](docs/TAXONOMY.md) · [`docs/EXAMPLES.md`](docs/EXAMPLES.md) · [`docs/DEFENSE_MATRIX.md`](docs/DEFENSE_MATRIX.md) · [`docs/REFERENCES.md`](docs/REFERENCES.md)
...
> 아래는 요약. 각 항목의 세부 예시·방어는 [`docs/TAXONOMY.md`](docs/TAXONOMY.md)와 [`docs/DEFENSE_MATRIX.md`](docs/DEFENSE_MATRIX.md)를 참조.
...
자세한 방어 매핑: [`docs/DEFENSE_MATRIX.md`](docs/DEFENSE_MATRIX.md)
...
주요 논문·연도·기여는 [`docs/REFERENCES.md`](docs/REFERENCES.md).
